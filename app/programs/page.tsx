...
const programs = [
  { tag: "Web Dev", title: "Frontend Engineering Bootcamp", level: "Beginner → Intermediate", duration: "12 Weeks", price: "₦150,000", spots: "14 spots left", open: false, desc: "Master the modern web stack — HTML, CSS, JavaScript, React, and Next.js. Build real projects, ship real code, and graduate with a portfolio that gets you hired or your first client.", curriculum: ["HTML5 & CSS3 Mastery", "JavaScript Fundamentals & ES6+", "React & Component Architecture", "Next.js & Full-Stack Basics", "Git, GitHub & Deployment", "Portfolio Project Build"] },
  { tag: "Data & AI", title: "Data Analytics & Python", level: "Beginner", duration: "8 Weeks", price: "₦120,000", spots: "8 spots left", open: false, desc: "Go from zero to data analyst. Learn Python, Pandas, SQL, and data visualization tools used by companies across Africa and globally. Land roles or freelance gigs in data.", curriculum: ["Python Fundamentals", "Pandas & NumPy for Data", "SQL & Database Querying", "Data Visualization with Matplotlib/Seaborn", "Excel + Google Sheets Advanced", "Capstone Data Project"] },
  { tag: "Design", title: "UI/UX Product Design", level: "All Levels", duration: "10 Weeks", price: "₦130,000", spots: "Open Enrollment", open: true, desc: "Learn to design products people actually love using. Master Figma, user research, wireframing, prototyping, and design systems. Build a world-class portfolio.", curriculum: ["Design Thinking & UX Research", "Wireframing & Information Architecture", "Figma Mastery", "Prototyping & User Testing", "Design Systems & Component Libraries", "Portfolio Case Study Build"] },
  { tag: "Cloud", title: "Cloud & DevOps Foundations", level: "Intermediate", duration: "8 Weeks", price: "₦140,000", spots: "6 spots left", open: false, desc: "Break into the high-paying world of cloud and infrastructure. Learn AWS, Linux, Docker, CI/CD, and the fundamentals of DevOps — all from an African tech perspective.", curriculum: ["Linux Command Line Mastery", "AWS Core Services (EC2, S3, RDS)", "Docker & Containerization", "CI/CD with GitHub Actions", "Infrastructure as Code Basics", "Cloud Security Fundamentals"] },
  { tag: "Freelance", title: "Tech Freelancing Masterclass", level: "All Levels", duration: "4 Weeks", price: "₦60,000", spots: "Open Enrollment", open: true, desc: "The complete business toolkit for turning your tech skills into income. Learn platforms, proposals, pricing, client management, and how to build a sustainable solo practice.", curriculum: ["Upwork & Direct Client Strategy", "Writing Proposals That Win", "Pricing Your Services Right", "Client Communication & Contracts", "Portfolio & Personal Branding", "Scaling to Agency or Retainers"] },
  { tag: "Business", title: "Digital Product Strategy", level: "Intermediate", duration: "6 Weeks", price: "₦100,000", spots: "10 spots left", open: false, desc: "For entrepreneurs and intrapreneurs who want to build digital products that work. Learn product discovery, roadmapping, MVPs, user research, and go-to-market strategy.", curriculum: ["Product Discovery & Problem Validation", "User Research Methods", "MVP Design & Prioritization", "Product Roadmapping", "Go-to-Market Strategy", "Metrics, Analytics & Iteration"] },
  { tag: "AI & ML", title: "Practical AI for Developers", level: "Intermediate", duration: "8 Weeks", price: "₦160,000", spots: "Coming Soon", open: false, desc: "Build AI-powered applications using the latest tools — OpenAI APIs, LangChain, vector databases, and fine-tuning. Go beyond prompting and start building production-ready AI products.", curriculum: ["LLM Fundamentals & Prompt Engineering", "OpenAI & Claude API Integration", "LangChain & Agentic Workflows", "Vector Databases & RAG Systems", "AI Product Design", "Deploying AI Applications"] },
  { tag: "Backend", title: "Backend Engineering with Node.js", level: "Beginner → Intermediate", duration: "10 Weeks", price: "₦140,000", spots: "12 spots left", open: false, desc: "Build the server-side of the internet. Master Node.js, Express, databases, REST APIs, authentication, and cloud deployment. The skills every serious dev team needs.", curriculum: ["Node.js & Async JavaScript", "Express.js REST API Design", "MongoDB & PostgreSQL", "Authentication & Authorization", "API Security & Best Practices", "Deployment to AWS/Render"] },
  { tag: "Mobile", title: "React Native Mobile Development", level: "Intermediate", duration: "10 Weeks", price: "₦150,000", spots: "Coming Soon", open: false, desc: "Build iOS and Android apps with one codebase. Learn React Native, Expo, navigation, state management, and publish your first app to the App Store and Google Play.", curriculum: ["React Native & Expo Setup", "Navigation & Routing", "State Management with Redux/Zustand", "Native APIs & Device Features", "App Store Deployment", "Final App Project"] },
];
...
const faqs = [
  ...
  { q: "Are certificates provided?", a: "Yes. Upon completion, graduates receive a BLUNT Technology certificate of completion and a verified badge for LinkedIn and their portfolio." },
];
              ...
              <RevealWrapper key={c.title} delay={String(i % 3 + 1)} style={{ background: "var(--card)" }}>
                <div style={{ padding: "28px 24px", height: "100%", display: "flex", flexDirection: "column" }}>
                  ...
                  <div style={{ display: "flex", gap: 20, marginBottom: 20, paddingTop: 16, borderTop: "1px solid var(--border)" }}>
                    <div><div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, textTransform: "uppercase", letterSpacing: "0.1em", color: "var(--muted)", marginBottom: 4 }}>Level</div><div style={{ fontSize: 12, color: "var(--dim)" }}>{c.level}</div></div>
