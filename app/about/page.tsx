...
const team = [
  ...
  { name: "Grace Ikpeme", role: "Member Board of Directors, Business Developer", bio: "Shapes BLUNT's strategic direction and drives business growth across sectors. MGrace ensures that every partnership and opportunity aligns with BLUNT's long-term mission.", initials: "MI" },
